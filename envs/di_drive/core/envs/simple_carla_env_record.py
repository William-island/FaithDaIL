...
from envs.di_drive.core.simulators import CarlaSimulator
from envs.di_drive.core.utils.env_utils.stuck_detector import StuckDetector
from envs.di_drive.core.utils.others.visualizer import Visualizer
from envs.di_drive.core.utils.simulator_utils.carla_utils import visualize_birdview
...
class SimpleCarlaEnv(BaseCarlaEnv):
    ...
    def compute_reward(self) -> Tuple[float, Dict]:
        ...
        lateral_factor = 1
        # from envs.di_drive.core.utils.simulator_utils.carla_utils import lane_mid_distance
