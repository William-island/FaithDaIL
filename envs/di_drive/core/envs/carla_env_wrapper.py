...
from envs.di_drive.core.data.benchmark import ALL_SUITES
from envs.di_drive.core.eval.carla_benchmark_evaluator import get_suites_list, read_pose_txt, \
    get_benchmark_dir
...
class BenchmarkEnvWrapper(CarlaEnvWrapper):
    ...
    def reset(self, *args, **kwargs) -> Any:
        ...
        if self._mode == 'random':
            ...
            print(
                "\033[31m [ENV] reset with param index: {} \033[0m".format(self._reset_param_index)
            )
